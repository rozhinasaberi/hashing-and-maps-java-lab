/*
 * lab 6 ex 1
 * this file is a shared map base class
 * common helper things are placed here so other map classes do not repeat code
 * abstract class was useful because the map idea is shared but the exact storage changes
 */
/*

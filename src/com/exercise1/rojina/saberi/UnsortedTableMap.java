/*
 * lab 6 ex 1 and ex 2
 * this file is the unsorted table map
 * it stores entries in a simple list without keeping order
 * i used this one in exercise 2 to show containskey still works even if a value is null
 */
/*
...
//added this method using findIndex to check if key exists

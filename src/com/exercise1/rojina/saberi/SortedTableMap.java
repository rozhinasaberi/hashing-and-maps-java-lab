/*
 * lab 6 ex 1
 * this file is the sorted table map implementation
 * entries are kept in sorted order so searching by order relations is possible
 * sorted storage is why methods like floorentry work here
 */
/*

/*
 * lab 6 ex 1
 * this file is the common parent for sorted map classes
 * it keeps compare related helper code in one place
 * sorted map needs comparisons because keys have to stay in order
 */
/*
